    ...
    >
      <View className="flex-row items-start justify-between gap-4">
        <View className="flex-1">
          <Text className="text-2xl font-semibold text-slate-900 text-right">{insight.title}</Text>
          <Text className="mt-2 text-lg text-slate-800 text-right">{insight.body}</Text>
        </View>
        <View
